...
namespace Car_Renting.Views
{
    public class categorytController : Controller
    {
        ...
        // GET: categoryt/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: categoryt/Create
